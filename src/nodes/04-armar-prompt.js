...
const prompt = [
  ...
  '',
  'ESTRATEGIA DE PERSUASIÓN: no vendas con adjetivos, vendé con un argumento. Cada texto tiene que acercar al prospecto a estas creencias, que son las que necesita tener antes de comprar:',
  '1) "mis clientes nuevos me buscan en Google antes de decidir"',
  '2) "si no aparezco con página propia, ese cliente se lo lleva el que sí aparece"',
  '3) "tener mi web no me exige tiempo ni saber de tecnología: me la hacen en 48hs con mis datos"',
  '4) "puedo ver una muestra gratis antes de pagar, así que no arriesgo nada"',
  '5) "lo que sale se recupera con los primeros clientes que lleguen por la web"',
  'El "mensaje" trabaja las creencias 1, 2 y 4. El "pitch" refuerza y suma la 3 y la 5. NO enuncies las creencias de forma literal: presentá hechos del negocio concreto que lleven al prospecto a concluirlas solo. Un buen argumento con datos reales convence más que diez adjetivos.',
  '',
